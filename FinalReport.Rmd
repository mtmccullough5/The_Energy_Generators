...
gasplot <- ggplot(data = totalGasCosts) +
  geom_point(mapping = aes(x = date_col, y = US_Gas_Gen, color = US_Gas_Price )) +
  geom_smooth(mapping = aes(x = date_col, y = US_Gas_Gen)) +
  geom_point(mapping = aes(x = date_col, y = US_Gas_Price)) + 
  geom_smooth(mapping = aes(x = date_col, y = US_Gas_Price)) +
...
uranplot <- ggplot(data = totalUranCosts) +
  geom_point(mapping = aes(x = date_col, y = US_Uran_Gen, color = US_Uran_Price )) +
  geom_smooth(mapping = aes(x = date_col, y = US_Uran_Gen)) +
  geom_point(mapping = aes(x = date_col, y = US_Uran_Price)) + 
  geom_smooth(mapping = aes(x = date_col, y = US_Uran_Price)) +
...
coalplot <- ggplot(data = totalCoalCosts) +
  geom_point(mapping = aes(x = date_col, y = US_Coal_Gen, color = US_Coal_Price )) +
  geom_smooth(mapping = aes(x = date_col, y = US_Coal_Gen)) +
  geom_point(mapping = aes(x = date_col, y = US_Coal_Price)) + 
  geom_smooth(mapping = aes(x = date_col, y = US_Coal_Price)) +
