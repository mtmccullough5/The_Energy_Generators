...
1. STATE vs ENERGY_SOURCE 
Graphing State vs Energy Source shows the type of energy source by each State. These include Coal, Geothermal, Hydroelectric Conventional, etc. 

2. STATE vs  TYPE_OF_PRODUCER
Graphing State vs Type_OF_Producer shows the type of prdoucer by each State. These include Combined Heat and Power and/or Commercial power, 
Electric Power, Industrial Power, etc. 
